...
date: 2019-02-08
title: 'Transforming exported CSV data for use in a chart.'
published: true
---
...
<div style=" position: relative; overflow: hidden; padding-top: 56.25%; margin-bottom: 25px">

<iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" src="https://egghead.io/lessons/react-redux-avoiding-array-mutations-with-concat-slice-and-spread/embed" frameBorder="0" allowFullScreen></iframe>
</div>
