...
Notes can take a variety of formats:
...
A good not can range from the size of a tweet to an entirely new course summarized from for the original content.
