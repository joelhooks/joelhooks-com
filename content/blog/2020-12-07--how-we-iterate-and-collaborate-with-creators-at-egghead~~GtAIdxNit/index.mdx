...
Something I've never had any desire to replicate is the DIY cookie-cutter "course platform" you see with sites like Teachable and Podia. They are fine sites enabling loads of creators to make decen content in very specific ways. It'd probably actually be easier, and "better business" if egghead took a more platform approach, and less of a hands on collaborative effort.
...
If you've spent time on Teachable and Podia or other DIY "learning content platforms" you probably know that cinsistency in quality is not universal.
...
We go all in on a feature from a design perspective. This include instructional design and visual design. 

A feature will have a budget, schedule, supporting materials, marketing and the full attention of our production staff.

### The Epic Course

This is a cornerstone of the egghead catalog. Take a feature level course and then get **ambitious as fuck**. Custom coursware. Significant budget. Outside collaborators.
