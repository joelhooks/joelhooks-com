...
If you'd like to check out our port of `video-react` you can find it **[here on github](https://github.com/skillrecordings/products/tree/main/packages/player)**. 2
