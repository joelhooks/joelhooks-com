...
We have to cosider how we lift up our users and make **them shine** instead of ourselves. We can replace "our" with "our users".
...
There are several curves in paly and they get more interesting when you also consider the creator curve(s) involved. _badass instructor_ is definitely one of the compelling contexts that we present.
