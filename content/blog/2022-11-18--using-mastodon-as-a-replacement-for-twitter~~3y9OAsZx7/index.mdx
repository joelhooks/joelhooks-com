...
I'm giving it a try, [find me here on Hachyderm instance](https://hachyderm.io/@joelhooks).
...
This time around I joined a [tech community focused Mastodon instance](https://hachyderm.io/@joelhooks) and [migrated my previous account](https://blog.joinmastodon.org/2019/06/how-to-migrate-from-one-server-to-another/) to it. It was quick and painless and the more focused community was a big boost to the overall vibe.
